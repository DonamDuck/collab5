...
check("칩 라벨: 노션(notion.site 하위 도메인)", channelLabel("https://earth-stitch-lyfe.notion.site/d38d7afff1ef43de86ef5c2925b689e4") === "Notion");
check("칩 라벨: 노션(notion.so)", channelLabel("https://www.notion.so/abc") === "Notion" && channelLabel("notion.so/x") === "Notion");
check("notion 흉내 도메인은 안 걸린다", channelLabel("https://notion.site.evil.com/x") === null && channelLabel("https://mynotion.so") === null);
check("연락 버튼 조사: Notion으로·카카오톡으로·리틀리로·카카오톡 채널로",
  resolveCollabChannel({ homepage: "https://x.notion.site/y" })?.label === "Notion으로 연락하기" &&
