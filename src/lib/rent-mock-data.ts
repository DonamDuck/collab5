...
function booking(p: BookingSeed, today: string): SpaceBooking {
  ...
  return {
    guestBrandSlug: "", guestPhone: "", hours: "", headcount: undefined,
...
function fullWorld(today: string, withAccount: boolean): MockWorld {
  ...
  const b = {
    pending: booking({ id: 90001, spaceId: s1.id, guestUserId: U.guest, status: "pending", useDate: d(5), startTime: "10:00", endTime: "14:00", plan, withChat: true, headcount: 3, guestPhone: "010-3456-7890", guestBrandSlug: "mock-flour-diary", ...P1 }, today),
    pendingPast: booking({ id: 90002, spaceId: s1.id, guestUserId: U.guest, status: "pending", useDate: d(-2), startTime: "12:00", endTime: "15:00", plan: "사진 촬영을 하려고 해요. 두 시간이면 충분해요.", guestPhone: "010-3456-7890", ...P1 }, today),
    ...
    payoutFailed: booking({ id: 90018, spaceId: s6.id, guestUserId: U.guest2, status: "done", useDate: d(-15), startTime: "18:00", endTime: "22:00", plan: "동네 모임을 했어요.", headcount: 10, guestPhone: "010-5678-9012", ...P6 }, today),
    ...
    hostAsGuest: booking({ id: 90020, spaceId: s6.id, guestUserId: U.host, status: "confirmed", useDate: d(4), startTime: "17:00", endTime: "20:00", plan: "원두 시음회를 다른 동네에서 열어 보려고 해요.", headcount: 10, guestPhone: "010-2345-6789", guestBrandSlug: "mock-slow-afternoon", decidedAt: `${d(-1)}T05:00:00.000Z`, ...P6 }, today),
  };
...
function stressWorld(today: string): MockWorld {
  ...
  const bookings = [
    ...
    booking({ id: 90103, spaceId: s.id, guestUserId: U.stressGuest, status: "done", useDate: d(-4), startTime: "08:00", endTime: "22:00", plan: longPlan, withChat: true, headcount: 80, guestPhone: "010-9999-8888", ...P }, today),
    booking({ id: 90104, spaceId: s.id, guestUserId: U.stressGuest, status: "pending", useDate: d(12), startTime: "09:00", endTime: "21:00", plan: longPlan, withChat: true, headcount: 60, guestPhone: "010-9999-8888", ...P }, today),
  ];
  const payments = [
