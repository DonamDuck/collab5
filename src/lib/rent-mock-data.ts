...
function fullWorld(today: string, withAccount: boolean): MockWorld {
  ...
  // ⏱S8 — 30분 단위 공간(대표 09-19: 「9시 30분 ~ 12시의 자투리도 가능」). 최소 1시간 30분.
  ...
  const s8 = space({
    id: 9110, slug: "mock-slow-afternoon-window", ownerUserId: U.host, status: "open",
    ...
    ...bizOf(U.host, "0000112347", "김느린", "20210315", "jpg", "000000009110"),
  ...
  const b = {
    ...
    halfPaid: booking({ id: 90021, spaceId: s8.id, guestUserId: U.guest, status: "paid", useDate: d(3), startTime: "13:00", endTime: "15:30", plan: "스터디 모임 다섯 명이 두 시간 반 동안 발표 연습을 해요.", headcount: 5, guestPhone: "010-3456-7890", guestName: "한서윤", guestBrandSlug: "mock-flour-diary", ...P8 }, today),
    halfConfirmed: booking({ id: 90022, spaceId: s8.id, guestUserId: U.guest, status: "confirmed", useDate: d(3), startTime: "16:30", endTime: "18:00", plan: "새로 구운 빵 사진을 창가 빛에서 찍으려고 해요.", headcount: 2, guestPhone: "010-3456-7890", guestName: "한서윤", decidedAt: `${d(-1)}T05:00:00.000Z`, ...P8 }, today),
