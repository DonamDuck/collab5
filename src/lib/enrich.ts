...
[고객] 주요 고객층 — ⭐사람 집단만(임산부·초보자·지역 주민·직장인·관광객·반려인). 감정·관심사·증상·수업 내용(마음공부·불안·유연성·힐링)은 고객이 아니다 → [제품·서비스]나 [특장점]으로. 확인된 것만.
...
[신뢰정보] 공식 홈페이지 URL · 주소.
[키워드] 이 브랜드를 나타내는 키워드 8~15개, 쉼표 구분 (각 2~15자 명사구, 문장 금지) — ⭐다른 브랜드와 구별되는 구체어 우선(제품명·프로그램명·소재·방식·공간의 특징). 어느 가게에나 붙는 일반어(카페·워크숍·예약제)는 뒤로. 다른 브랜드 것 섞지 말 것.
