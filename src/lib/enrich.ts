...
🚨⛔**짧은 필드에는 위 규칙을 적용하지 마라** — 활동·콜라보의 "desc", 각종 "note"·힌트는 **한두 문장 사실 기술**이 정답이다. 서술어를 "~하고 있어요"·"~했어요"로 딱 잘라 끝내고, "~하는 자리를/시간을 만들었습니다" 같은 **명사화로 닫지 마라**. 짧은 칸에 페이오프를 욱여넣으면 글이 길어지고 일기처럼 읽힌다(08-02 실제 사고).
