...
- ⭐지금 하고 있는 일·현황은 '계속되고 있음'이 느껴지는 현재형으로 쓴다: ~하고 있어요 / ~이어가고 있어요 / ~해오고 있어요 / (혼합체 문장이면) ~하고 있습니다. 과거에 시작했어도 지금도 하는 일이면 과거형(~했어요)으로 끝내지 마라 — "2013년에 시작했어요"(X, 끝난 느낌) → "2013년에 시작해 지금까지 이어가고 있어요"(O). 과거형은 정말 끝난 일(지난 콜라보·행사 이력)에만.
