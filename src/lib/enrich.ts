...
[이용] 그 공간을 쓰는 방식·갖춘 것 중 ⭐브랜드 성격이 드러나는 것만 (예: 요가 매트 대여, 탈의실, 대기 공간, 반려동물 동반, 단체석, 원데이 예약제, 포장 가능). ⛔가격·전화·영업시간은 여기 쓰지 마라. ⛔와이파이·정수기·화장실처럼 어느 업소에나 있어 브랜드를 설명 못 하는 것도 빼라
[신뢰정보] 홈페이지 URL · 주소
...
const CHIP_SECTIONS: Record<string, { label: string; factual: boolean }> = {
  ...
  이용: { label: "이용", factual: false }, // 공간을 쓰는 방식·갖춘 것(브랜드 성격 드러나는 것만 — 대표 정책 07-20)
