...
· 활동으로 승격하는 건 '반복되는 것'만: 정기 프로그램·대표 메뉴·상시 서비스. 일회성 행사는 활동이 아니라 콜라보·소개된 곳 재료다.
...
⭐activityHints는 '반복되는 것'(대표 메뉴·정기 프로그램·상시 서비스·매달 반복 기획의 일반화)만 0~5건 — 근거가 있으면 적극 추출. collabHints는 파트너명이 드러난 협업만 0~3건. (source=출처 유형, 홈페이지 발췌면 "홈페이지"). 자료에 없으면 빈 배열 — 지어내기 금지.`;
