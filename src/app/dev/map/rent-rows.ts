  ...
  },
  {
    ...
    screens: [
      ...
      },
      {
        title: "공간 올리기",
        path: "/rent/new",
        note: "임시 저장 복원은 링크로 못 열어요. 폼에 몇 칸 적고 새로고침하면 복원 안내가 떠요. 저장은 계정마다 따로 브라우저에 남아요. 「무엇을 파실까요」에서 상품을 하나도 안 켜고 「등록하기」를 누르면 상품 오류가, 켜고 값·설명을 비우면 그 칸 오류가 떠요. 「사업자 정보」 칸의 오류는 아래 「공간 고치기」에서 보는 게 빨라요(다른 칸이 이미 차 있어서). 🧾사업자등록증 칸에서 아무 사진이나 PDF를 고르면 목 모드라 저장소에 안 올리고 바로 글자 읽기로 가요. Gemini는 안 부르고 정해 둔 결과로 빈 칸만 채워요. 칸을 먼저 적어 두고 고르면 적어 둔 칸은 안 덮고, 등록증과 다른 칸 밑에만 「등록증에는 ○○○로 적혀 있어요」 한 줄이 떠요. 공간 주소를 비워 두고 고르면 「등록증 주소로 채우기」 제안도 떠요(넣을 때 「서울특별시」를 주소 찾기 표기 「서울」로 바꿔요).",
        rows: [
          ...
          { desc: "등록증을 고르면 「등록증을 읽고 있어요…」 뒤 상호·번호·대표자·개업일이 채워지고 「맞는지 한 번 확인해 주세요」 한 줄", c: "host-full", to: "/rent/new#f-bizCert" },
