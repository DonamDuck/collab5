      ...
      <div className="mt-10 space-y-9">
        ...
        <Article title="제2조 (등록 정보의 정확성)">
          <ul className="list-disc space-y-1 pl-5">
            ...
            {/* 🏠09-19 오후 대표 — 주소가 바뀌면 사업자등록증을 다시 받는다(`addressCertProblem`). 상호만 바꾸는 건 그대로다. */}
            <li>
              공간의 이름이나 주소가 바뀌면 회사의 확인을 다시 거칩니다. 주소가 바뀐 경우 호스트는 새 주소가 적힌
              사업자등록증을 다시 제출합니다. 그 밖의 내용은 호스트가 언제든 고칠 수 있습니다.
            </li>
          </ul>
        </Article>
