      ...
      <div className="mt-10 space-y-9">
        ...
        <Article title="제2조 (등록 정보의 정확성)">
          <ul className="list-disc space-y-1 pl-5">
            ...
            {/* 🔁09-19 저녁 대표 — 주소가 바뀌어도 등록증을 새로 받지 않는다. 회사가 등록증과 견줘 보고 맞지 않으면 보완을 요청한다(검토 화면 [보완 요청]). */}
            <li>
              공간의 이름이나 주소가 바뀌면 회사의 확인을 다시 거칩니다. 회사는 등록된 내용이 사업자등록증과 맞지 않으면
              호스트에게 보완을 요청할 수 있고, 호스트가 보완해 다시 제출할 때까지 공간은 목록에 보이지 않습니다. 그 밖의
              내용은 호스트가 언제든 고칠 수 있습니다.
            </li>
          </ul>
        </Article>
