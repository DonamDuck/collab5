    ...
    <main className="mx-auto max-w-[760px] px-5 py-12 sm:px-6 sm:py-16">
      ...
      <div className="mt-10 space-y-9">
        ...
        <Article id="rent" title="제10조 (하루 팝업 이용)">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            {/* 🔁09-19 대표 — 「결제 후 1시간」을 없애고 «호스트 수락 뒤 1시간»으로 옮겼다(`GRACE_MINUTES`).
                🆕09-19 오후 대표 — 「수락 전 취소는 당연히 전액 취소」. 수락 전 줄을 맨 앞에 둔다(`CancelStage`). */}
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>이용일 기준 환불은 호스트가 수락하고 1시간이 지난 뒤의 취소에 적용하며, 남은 날짜는 이용일을 기준으로 한국 시간 날짜로 셉니다.</li>
