      ...
      <div className="mt-10 space-y-9">
        <Article title="1. 수집하는 개인정보 항목">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            {/* 🏠09-17 하루 가게 — 손님 전화번호를 신청 때 필수로 받기로 했다(대표). 결제 정보는 토스가 받고 우리는 결과만 남긴다. */}
            <li>
              <b>하루 가게 이용 시</b>: 휴대전화 번호, 이용 날짜·시간·인원·이용 목적, 결제 결과(결제 수단 종류·금액·승인 번호).
              카드 번호 등 결제 수단 정보는 토스페이먼츠가 직접 받으며 회사는 보관하지 않습니다.
            </li>
            <li>
        ...
        <Article title="2. 개인정보의 수집 및 이용 목적">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>하루 가게 예약·결제·환불 처리, 호스트와 이용자 간 연락, 거래 기록 보관</li>
        ...
        <Article title="4. 개인정보의 제3자 제공">
          ...
          {/* 🏠09-17 — 하루 가게는 결제가 끝나면 거래 상대방에게 연락처를 연다. 이건 «제3자 제공»이라 따로 적어야 한다. */}
          <p className="mt-2">
            하루 가게에서 결제가 끝나면 거래 상대방에게 아래 정보를 제공합니다.
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              <b>호스트에게</b>: 이용자의 이름(브랜드명)·휴대전화 번호·이메일, 이용 날짜·시간·인원·이용 목적. 예약 이행과
              연락 목적이며, 이용일이 지나면 화면에서 가립니다.
            </li>
            <li>
              <b>이용자에게</b>: 호스트의 이름(브랜드명)·휴대전화 번호·이메일, 매장 전화·주소. 예약 이행과 연락 목적이며,
              이용일이 지나면 화면에서 가립니다.
            </li>
          </ul>
        </Article>
        ...
        <Article title="5. 개인정보 처리의 위탁">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>토스페이먼츠 주식회사 — 하루 가게 결제 처리, 환불, 판매자 정산(지급대행)</li>
            <li>Resend, Inc. — 예약·결제 안내 메일 발송</li>
          </ul>
        </Article>
        ...
        <Article title="5-1. 개인정보의 국외 이전">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              <b>이전받는 자</b>: Supabase Inc., Vercel Inc., Google LLC, Resend, Inc.
            </li>
            <li>
              <b>이전 국가·시점·방법</b>: 미국 등 각 사업자의 서비스 리전. 서비스 이용 시점에 네트워크를 통해 전송
            </li>
            <li>
              <b>이전 항목</b>: 회원 식별 정보, 브랜드 소개서 작성 내용(상호·주소·채널·소개 문구·사진), 서비스 이용 기록, 안내 메일의 받는 주소와 본문(Resend)
            </li>
            <li>
