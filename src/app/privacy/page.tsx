      ...
      <div className="mt-10 space-y-9">
        <Article title="1. 수집하는 개인정보 항목">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              <b>하루 가게 이용 시</b>: 이용자 성함, 휴대전화 번호, 이용 날짜·시간·인원·이용 목적, 결제 결과(결제 수단 종류·금액·승인 번호).
            ...
            <li>
              <b>하루 가게에 공간을 올릴 때</b>: 상호, 사업자등록번호, 대표자 이름, 개업일, 사업자등록증 이미지(또는 PDF).
            ...
            <li>
              <b>하루 가게에 공간을 올린 분이 정산 계좌를 등록할 때</b>: 예금주 이름, 은행, 계좌번호, 사업자 유형,
        ...
        <Article title="2. 개인정보의 수집 및 이용 목적">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>하루 가게 예약·결제·환불 처리, 호스트와 이용자 간 연락, 거래 기록 보관, 호스트 정산금 지급</li>
            <li>하루 가게에 공간을 올린 분의 사업자 확인(국세청 조회·등록증 검토)</li>
        ...
        <Article title="4. 개인정보의 제3자 제공">
          ...
          {/* 🏠09-17 — 하루 가게는 거래 상대방에게 연락처를 연다. 이건 «제3자 제공»이라 따로 적어야 한다.
              🪪09-19 — 「결제가 끝나면 양쪽에」가 실제와 달랐다. 이용자 쪽 문은 결제 뒤(`guestSeesHost`), 호스트 쪽 문은 수락 뒤(`isRevealed`)다. */}
          <p className="mt-2">
            하루 가게에서는 예약을 이행하기 위해 거래 상대방에게 아래 정보를 제공합니다.
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
          ...
          <p className="mt-2">
            하루 가게에 공간을 올리면 사업자 확인을 위해 <b>국세청</b>(공공데이터포털 사업자등록정보 진위확인 서비스)에
