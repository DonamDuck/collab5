        ...
        {/* 🆕3번칸 「소개서 등록」(대표 지시 08-16) — ④ 소개서 구좌로 **앵커 점프**한다.
            ...
            🪤**칸이 셋이 되며 폭 압박이 돌아왔다.** 2번칸을 「콜라보 아이디어 찾기」에서
              **「콜라보 아이디어」**로 줄인 게 그 대가다(대표 지시 — 2글자 덜어냈다).
              📏실측 @360(가용 343) — 세 칸 합계 폭과 여유:
                · 검색·**콜라보 아이디어 찾기**·등록 365.0 → **-22.0 ❌** (알약이 화면을 넘는다)
                · 검색·콜라보 아이디어·등록      335.4 → +7.6
                · **검색·아이디어 추천·등록      322.4 → +20.6 ✅** ← 지금 이것

            ✍️**「콜라보 아이디어」가 심심하다**는 지적(대표)의 원인은 **길이가 아니라 병렬이 깨진 것**이었다.
              「콜라보 검색」·「소개서 등록」은 [대상][행동]인데 가운데만 [대상][대상]이라
              **뭘 하는 칸인지 혼자 안 말했다.** 「아이디어 추천」으로 바꾸니 셋 다 [대상][행동] 6자로
              나란해진다 — 길이를 늘리지 않고 심심함이 풀린다.
              ⭐목적지 버튼이 「나도, 콜라보 아이디어 **추천**받기」라 어휘도 이어진다.
              🔻「콜라보 찾기」 → **「콜라보 검색」**(대표 지시). 폭은 68.5로 동일하고,
                「찾기」가 아래 「추천」·「등록」과 어미가 겹치지 않아 셋의 구분이 또렷해진다.
